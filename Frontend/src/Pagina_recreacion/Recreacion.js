    ...
    <>
      <div className="Recreacion">
        <button type="button" class="btn btn-outline-secondary btn-Cult">
          <Link to="/recre">Volver</Link>
        </button>
        <h1 class="h3 mb-Cultura font-weight-center">Recreacion </h1>
        <h2 class="h3 mb-Cult font-weight-normal">
          {" "}
          En el corregimiento podemos encontrar muchos espacios recreativos para
          que compartas con tus amigos o familiares,lo bueno de esto es que
          puedes escoger que quieres explorar y conocer de acuerdo con tus
          deseos, en Santa Elena podemos encontrar desde espacios
